...
public class CabAnalysis {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple8<String, String, String, String, Boolean, String, String, Integer>> data =
                env.readTextFile("C:\\Users\\A474447\\Downloads\\apache-flink\\src\\main\\resources\\test\\cab+info").map(new MapFunction<String, Tuple8<String, String, String, String, Boolean, String, String, Integer>>() {
        ...
        popularDest.writeAsText("C:\\Users\\A474447\\Downloads\\apache-flink\\src\\main\\resources\\test\\popular_dest_batch.txt").setParallelism(1);
        ...
        avgPassPerTrip.writeAsText("C:\\Users\\A474447\\Downloads\\apache-flink\\src\\main\\resources\\test\\avg_passengers_per_trip.txt").setParallelism(1);
        ...
        avgPassPerDriver.writeAsText("C:\\Users\\A474447\\Downloads\\apache-flink\\src\\main\\resources\\test\\avg_passengers_per_driver.txt").setParallelism(1);
